<template>
    ...
    <div id="recuadroVista">
        ...
        <ListaPrecios v-if="listaIsDisabled === false" v-bind:listaPerfumes="perfumes" v-on:enviar="recibirDatos">
        </ListaPrecios>
        <Formateador v-if="(!!selectedItemsParent)" v-bind:perfumesSeleccionados="selectedItemsParent">
        </Formateador>
    </div>
</template>
